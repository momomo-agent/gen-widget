...
const SYSTEM_PROMPT = [
  ...
  ".w-row — 横排  .w-col — 竖排  .w-action — tinted 胶囊按钮（浅蓝底+蓝字）",
  ...
  ".w-up — 绿色文字（涨）  .w-down — 红色文字（跌）  .w-divider — 细分割线",
  "",
  "## 🎨 色彩变化（让每组 widget 不单调）",
  ...
  "不加 = 默认白色毛玻璃。每组建议 2-3 个有色 widget。",
  "",
  "## 示例",
  '{"widgets":[',
  ...
  '{"size":"2x2","html":"<div class=\'w-icon\'>🚇</div><div class=\'w-label\'>通勤</div><div class=\'w-value\'>25<span class=\'w-unit\'>分钟</span></div><div class=\'w-meta\'>2号线 · 8:40 到站</div>"},',
  '{"size":"4x2","html":"<div class=\'w-row\'><div class=\'w-icon\'>📋</div><div class=\'w-col\'><div class=\'w-title\'>今日日程</div><div class=\'w-label\'>3 个会议</div></div></div><div class=\'w-list-item\'><div class=\'w-list-time\'>09:30</div>产品周会</div><div class=\'w-list-item\'><div class=\'w-list-time\'>14:00</div>项目评审</div><div class=\'w-meta\'>还有 2 小时</div>"},',
  ...
  "5. 内容少而精 — 2x2 最多 4 个元素，4x2 列表最多 2 项",
  "6. 每组 5-6 个 widget，2-3 个用彩色底",
  "7. 用 emoji 做图标",
